...
//class variables
	...
	public User(int i,String p){      //2 param const...
		System.out.println("2 params const..." +i + p);
	}
	
	//create a const with all class variables:
	...
	//U can create with limited class variables too
	...
	System.out.println(us4.age +" "+us4.userid+" "+us4.isActive);
	
	User us5 = new User("Tom",23,1008,4);
	System.out.println(us5.name);
	System.out.println(us5.wheels);
	System.out.println(us5.age+" "+us5.userid);
	}
